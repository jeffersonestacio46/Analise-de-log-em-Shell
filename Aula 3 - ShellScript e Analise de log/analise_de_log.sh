...
banner3()
{
    ...
    echo "Github: https://github.com/jeffersonestacio46/Analise-de-log-em-Shell/blob/main/Aula%203%20-%20ShellScript%20e%20Analise%20de%20log/analise_de_log.sh"
}
